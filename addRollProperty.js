...
// Add Roll Property and give the value 'intern' to the last 10 employees 


// let emp =  employee.Roll = "intern"
 

// for(let i = employee.length-1 ; i<=10 ; i-- )
//     {
//         console.log(`employee id = ${employee.id} employeName ${employee.EmployeeName} property ${emp}`)
